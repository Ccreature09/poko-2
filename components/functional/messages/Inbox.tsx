/**
 * Компонент за входяща поща
 * 
 * Показва списък с всички разговори на потребителя в опростен изглед:
 * - Извлича разговорите от Firebase база данни
 * - Показва имената на участниците в разговора
 * - Показва кратко превю на последното съобщение
 * - Осигурява връзки към пълния изглед на всеки разговор
 * 
 * Забележка: Това е опростена версия на ConversationList компонента,
 * използвана за бърз преглед на съобщенията
 */
