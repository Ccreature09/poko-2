...
export default function GradingScaleEditor({
  ...
  const [gradingScale, setGradingScale] =
    useState<BulgarianGradingScale>(initialScale);
  const [isValid, setIsValid] = useState<boolean>(true);
  const [isDirty, setIsDirty] = useState<boolean>(false);
  const [errors, setErrors] = useState<string[]>([]);

  const validateScale = useCallback(() => {
    ...
    const allRanges = [
      {
        name: "Слаб 2",
        min: gradingScale.poor.min,
        max: gradingScale.poor.max,
      },
      {
        name: "Среден 3",
        min: gradingScale.average.min,
        max: gradingScale.average.max,
      },
      {
        name: "Добър 4",
        min: gradingScale.good.min,
        max: gradingScale.good.max,
      },
      {
        name: "Мн. Добър 5",
        min: gradingScale.veryGood.min,
        max: gradingScale.veryGood.max,
      },
      {
        name: "Отличен 6",
        min: gradingScale.excellent.min,
        max: gradingScale.excellent.max,
      },
    ];
    ...
    allRanges.forEach((range) => {
      if (range.min < 0 || range.max > 100) {
        validationErrors.push(
          `${range.name}: Стойностите трябва да са между 0 и 100`
        );
      }
      if (range.min > range.max) {
        validationErrors.push(
          `${range.name}: Минималната стойност трябва да е по-малка от максималната`
        );
      }
    });
    ...
    if (gradingScale.poor.max + 1 !== gradingScale.average.min) {
      validationErrors.push(
        "Диапазонът между Слаб 2 и Среден 3 трябва да е последователен"
      );
    }
    if (gradingScale.average.max + 1 !== gradingScale.good.min) {
      validationErrors.push(
        "Диапазонът между Среден 3 и Добър 4 трябва да е последователен"
      );
    }
    if (gradingScale.good.max + 1 !== gradingScale.veryGood.min) {
      validationErrors.push(
        "Диапазонът между Добър 4 и Мн. Добър 5 трябва да е последователен"
      );
    }
    if (gradingScale.veryGood.max + 1 !== gradingScale.excellent.min) {
      validationErrors.push(
        "Диапазонът между Мн. Добър 5 и Отличен 6 трябва да е последователен"
      );
    }
  ...
  }, [useCustomScale, isDirty, onChange, onError, validateScale]);
  ...
  }, [gradingScale, isValid, isDirty, useCustomScale, onChange]);
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Задайте процентните диапазони за всяка оценка по Българската система
          за оценяване.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {useCustomScale ? (
          <div className="space-y-6">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("poor", "min", e.target.value)
                    }
                  />
                  <span>-</span>
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("poor", "max", e.target.value)
                    }
                  />
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("average", "min", e.target.value)
                    }
                  />
                  <span>-</span>
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("average", "max", e.target.value)
                    }
                  />
                  <span className="text-sm text-gray-500">%</span>
                </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("good", "min", e.target.value)
                    }
                  />
                  <span>-</span>
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("good", "max", e.target.value)
                    }
                  />
                  <span className="text-sm text-gray-500">%</span>
                </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("veryGood", "min", e.target.value)
                    }
                  />
                  <span>-</span>
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("veryGood", "max", e.target.value)
                    }
                  />
                  <span className="text-sm text-gray-500">%</span>
                </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("excellent", "min", e.target.value)
                    }
                  />
                  <span>-</span>
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("excellent", "max", e.target.value)
                    }
                  />
                  <span className="text-sm text-gray-500">%</span>
                </div>
            ...
            <Button variant="outline" onClick={resetToDefault} className="mt-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500">
              Включете опцията &quot;Персонализирана скала&quot;, за да
              промените процентните диапазони за всяка оценка.
            </p>
          </div>
        )}
      </CardContent>
