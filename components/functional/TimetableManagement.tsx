      ...
      <CardContent className="pt-6">
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
            <Label htmlFor="class-select" className="text-gray-700 mb-2 block">
              Изберете клас
            </Label>
                ...
                <div className="inline-block min-w-full align-middle">
                  <table className="w-full border-collapse">
                    <thead className="bg-gray-100">
                      <tr>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider border border-gray-200">
                          Час
                        </th>
                        {days.map((day) => (
                          <th
                            key={day}
                            className="px-4 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider border border-gray-200"
                          >
                            {day}
                          </th>
                        ))}
                                ...
                                <SelectContent>
                                  {subjects.length > 0 ? (
                                    subjects.map((subject) =>
                                      subject.teacherSubjectPairs.map(
                                        ({ teacherId }) => (
                                          <SelectItem
          ...
          {!selectedClass && (
            <div className="text-center p-8 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <p className="text-sm text-gray-400 mt-1">
                Моля, първо изберете клас от списъка по-горе
              </p>
            </div>
          )}
        </div>
