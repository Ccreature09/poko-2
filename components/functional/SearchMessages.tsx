/**
 * Компонент за търсене на съобщения
 * 
 * Предоставя разширени възможности за търсене в съобщенията:
 * - Търсене по ключови думи в текста
 * - Филтриране по времеви период (от дата - до дата)
 * - Филтър за непрочетени съобщения
 * - Показване на намерените резултати в прегледен списък
 * 
 * Функционалности:
 * - Интерактивен календар за избор на дати
 * - Незабавно търсене при промяна на филтрите
 * - Възможност за изчистване на всички филтри
 * - Визуализация на резултатите с контекст на разговора
 */
