...
import { deleteNotification } from '@/lib/notificationManagement';
...
const ParentLinkRequestCard: React.FC<ParentLinkRequestCardProps> = ({ 
  ...
  const handleResponse = async (response: 'accepted' | 'rejected') => {
    ...
    try {
      ...
      toast({
        title: response === 'accepted' ? 'Заявката е приета' : 'Заявката е отхвърлена',
  ...
  return (
    <Card className="mb-4">
      <CardHeader>
        ...
        <CardDescription>
          Родител иска да се свърже с вашия акаунт, за да вижда вашите оценки, присъствия и друга информация.
        </CardDescription>
      </CardHeader>
      <CardContent>
