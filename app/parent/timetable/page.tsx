...
import { Calendar, Clock, User, BookOpen, CalendarRange, AlertCircle } from "lucide-react";
...
export default function ParentTimetable() {
  ...
  const [children, setChildren] = useState<{ id: string; name: string; classId?: string }[]>([]);
                ...
                <div className="flex items-center md:ml-auto">
                  <div className="flex items-center text-sm">
                    <input
                      ...
                      onChange={(e) => setHighlightCurrentPeriod(e.target.checked)}
                      className="mr-2"
                    />
                    <label htmlFor="highlightCurrent">Маркирай текущия час</label>
                  </div>
                </div>
              </div>
            </div>
          ...
          {loading || childTimetableLoading ? (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Моля, изберете дете, за да видите разписанието.</CardDescription>
              </CardHeader>
            </Card>
          ) : (
                                  ...
                                  {details.map((detail, index) => {
                                    ...
                                    return (
                                      <div key={index} className="flex flex-col items-center">
                                        <div>
                                          <Badge className={`${getSubjectColor(detail.subject)} font-medium`}>
                                            {detail.subject}
                                          </Badge>
                                        </div>
                                    ...
                                    return (
                                      <div key={index} className="space-y-2">
                                        <div className="flex items-center justify-center">
                                          <Badge className={`${getSubjectColor(detail.subject)} px-3 py-1 text-sm`}>
                                            {detail.subject}
                                          </Badge>
                                        </div>
