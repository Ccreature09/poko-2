    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-4 md:p-8 overflow-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          <div>
            ...
            <p className="text-gray-600">
              {user.role === 'parent' ? `Успех на ${getStudentName()}` : 'Вашият успех'}
            </p>
          </div>
        ...
        {user.role === 'student' ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                  ...
                  {latestGrades.length === 0 && (
                    <div className="col-span-4 text-center py-10 bg-white rounded-lg border">
                      ...
                      <p className="text-gray-500">Все още нямате оценки</p>
                    </div>
                  )}
                </div>
          ...
          // Parent view - now supports both card and table views
          <>
            {isLoadingChildren ? (
              ...
              <div className="grid gap-6">
                ...
                {Object.keys(groupedGrades).length === 0 && !isLoadingChildren && (
                  <div className="text-center py-10 bg-white rounded-lg border">
                    <BarChart className="w-12 h-12 text-gray-300 mx-auto mb-3" />
                    <p className="text-gray-500">Все още няма оценки</p>
                  </div>
